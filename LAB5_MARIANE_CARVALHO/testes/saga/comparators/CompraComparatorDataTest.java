...
class CompraComparatorDataTest {
    ...
    void testCompareMenor() {
        Compra compra2 = new Compra("X-burguer", "Hamburguer de carne com queijo e calabresa", 4.50, "25/03/2019", "Victor Emanuel", "Marcos");
    ...
    void testCompareMaior() {
        Compra compra2 = new Compra("X-burguer", "Hamburguer de carne com queijo e calabresa", 4.50, "23/03/2019", "Victor Emanuel", "Marcos");
        int comparacao = this.comparador.compare(compra1, compra2);
        assertTrue(comparacao > 0);
    }
