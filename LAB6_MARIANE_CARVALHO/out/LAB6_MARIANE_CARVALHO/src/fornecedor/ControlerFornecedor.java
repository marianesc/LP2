...
public class ControlerFornecedor {
	...
	public void adicionaCombo(String fornecedor, String nome, String descricao, double fator, String produtos) {
		...
		Util.testaNull(this.fornecedores.get(fornecedor), "Erro no cadastro de combo: fornecedor nao existe.");
		...
		for (String prod : prods) {
			...
			Util.testaNull(produto, "Erro no cadastro de combo: produto nao existe.");
		...
		this.fornecedores.get(fornecedor).adicionaCombo(nome, descricao, precoIntegral, fator);
	}
	...
	public void editaCombo(String nome, String descricao, String fornecedor, double novoFator) {
		...
		Util.testaNull(this.fornecedores.get(fornecedor), "Erro na edicao de combo: fornecedor nao existe.");
