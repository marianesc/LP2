...
/**
 * Classe responsável por fazer o controle geral do sistema.
 *
...
public class ControlerCentral {
	...
	/**
	 * Instância do controlador de cliente.
	 */
	ControlerCliente cc = new ControlerCliente();

	/**
	 * Instância do controlador de fornecedor.
	 */
	ControlerFornecedor cf = new ControlerFornecedor();

	/**
	 * Constroi um controlador central, inializando os atributos.
	 */
